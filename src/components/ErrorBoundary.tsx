...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    // Additional debugging for timeout-related errors
    if (error.message.includes('timeout') || error.message.includes('30000ms')) {
      console.error('Timeout error detected:', error.message);
    }
  }
